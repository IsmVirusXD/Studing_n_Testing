...
button_mut = Button(root, text="*", padx=40, pady=20,
                  command=button_mutiply)
button_div = Button(root, text="/", padx=40, pady=20,
                  command=button_divide)
button_eql = Button(root, text="=", padx=86, pady=20,
                  command=button_equal)
button_clr = Button(root, text="clear", padx=78, pady=20,
